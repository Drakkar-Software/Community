...
ActiveRecord::Schema.define(version: 2022_06_25_113656) do
  ...
  create_table "spree_drm_records", id: :serial, force: :cascade do |t|
    t.integer "digital_id"
    t.integer "line_item_id"
    t.string "attachment_file_name"
    t.string "attachment_content_type"
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["digital_id"], name: "index_spree_drm_records_on_digital_id"
    t.index ["line_item_id"], name: "index_spree_drm_records_on_line_item_id"
  end
