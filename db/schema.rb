...
ActiveRecord::Schema.define(version: 2022_04_03_212034) do
  ...
  create_table "spree_backtesting_runs", force: :cascade do |t|
    t.bigint "product_id"
    t.bigint "user_id"
    ...
    t.string "token"
    t.index ["product_id"], name: "index_spree_backtesting_runs_on_product_id"
    t.index ["token"], name: "index_spree_backtesting_runs_on_token"
    t.index ["user_id", "product_id"], name: "index_spree_backtesting_runs_on_user_id_and_product_id"
    t.index ["user_id"], name: "index_spree_backtesting_runs_on_user_id"
  end
  ...
  create_table "spree_credits_purchases", force: :cascade do |t|
    t.bigint "user_id"
    ...
    t.datetime "updated_at", null: false
    t.string "comment"
    t.index ["user_id"], name: "index_spree_credits_purchases_on_user_id"
  end
  ...
  create_table "spree_daily_run_counters", force: :cascade do |t|
  ...
  create_table "spree_donations", force: :cascade do |t|
    ...
    t.decimal "dollar_value", default: "0.0"
    t.string "currency"
    t.string "blockchain"
    t.string "transaction_id"
    t.string "address_to"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["transaction_id", "blockchain"], name: "unique_spree_donations_transaction_id_per_blockchain", unique: true
  end
  ...
  create_table "spree_hosts", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end

  create_table "spree_inventory_relationships", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "product_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "secret_key"
    t.string "current_access_token", default: ""
    t.boolean "activated", default: true
    t.decimal "total_cost", precision: 10, scale: 2, default: "0.0"
    t.datetime "last_payment_at"
    t.decimal "promotion_ratio", precision: 5, scale: 2, default: "0.0"
    t.boolean "paid_for_today", default: true
    t.index ["product_id"], name: "index_spree_inventory_relationships_on_product_id"
    t.index ["secret_key"], name: "index_spree_inventory_relationships_on_secret_key", unique: true
    t.index ["user_id", "product_id"], name: "index_spree_inventory_relationships_on_user_id_and_product_id", unique: true
    t.index ["user_id"], name: "index_spree_inventory_relationships_on_user_id"
  end
  ...
  create_table "spree_microtransactions", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "purchase_type", default: "product"
    t.index ["user_id"], name: "index_spree_microtransactions_on_user_id"
  end
  ...
  create_table "spree_renting_costs", force: :cascade do |t|
    t.bigint "inventory_relationship_id"
    t.decimal "amount", precision: 10, scale: 2
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["inventory_relationship_id"], name: "index_spree_renting_costs_on_inventory_relationship_id"
  end
