...
output "database_parameter_group_id" {
  value       = module.rds_instance.parameter_group_id
  description = "ID of the Parameter Group"
}

output "database_option_group_id" {
...
output "database_public_subnet_cidrs" {
  value = module.subnets.public_subnet_cidrs
}

output "database_private_subnet_cidrs" {
  value = module.subnets.private_subnet_cidrs
}
...
# cache
output "cache_public_subnet_cidrs" {
  value       = module.subnets.public_subnet_cidrs
  description = "Public subnet CIDRs"
}

output "cache_private_subnet_cidrs" {
  value       = module.subnets.private_subnet_cidrs
  description = "Private subnet CIDRs"
}

output "cache_vpc_cidr" {
  value       = module.vpc.vpc_cidr_block
...
output "cache_cluster_reader_endpoint_address" {
